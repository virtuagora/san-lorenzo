<template>
  <section>
    ...
    <h1 class="subtitle is-6">(Podés cambiarlo antes de enviar tu voto)</h1>
      ...
      <button v-on:click.prevent="$router.push({ name: 'PublicStep1'})" class="button is-success is-outlined is-fullwidth is-medium">
    ...
    <h1 class="subtitle is-6">(Podés cambiarlo antes de enviar tú voto)</h1>
      ...
      <button v-on:click.prevent="$router.push({ name: 'PublicStep2'})" class="button is-link is-outlined is-fullwidth is-medium">
     <i class="fas fa-reply fa-fw "></i>&nbsp;Cambiar mi selección
    </button>
    <hr>
